...
include __DIR__ . '/template_messages.php';
		...
		<div id="bx-soa-order" class="row orderform--v1 bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-8 bx-soa">
                ...
                <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
                    ...
                    <div class="bx-soa-section-content container-fluid"></div>
                    <div class="btn-custom btn-full btn_next_step_order"><span>Далее</span></div>
                    <div class="clearfix"></div>
                </div>

				<div class="pandd<?if(isset($_COOKIE["ORDER_OPENED"]) && $_COOKIE["ORDER_OPENED"] == "Y"):?> opened<?endif;?>">
                    <div class="bx-soa-section-title-container delivery_main_title">
                        <h2 class="bx-soa-section-title col-sm-12">
                            <span class="bx-soa-section-title-count"></span>Доставка и оплата</h2>
                    </div>
					<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
						...
						<!--	DELIVERY BLOCK	-->
						<div id="bx-soa-delivery" data-visited="false" class="devicer-delivery-blockk bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title col-sm-9">
					...
					<? else: ?>
                        <?if($arParams['SHOW_COUPONS_DELIVERY'] === 'Y' || $arParams['SHOW_COUPONS_PAY_SYSTEM'] === 'Y'):?>
                            <div id="bx-soa-coupon" data-visited="false" class="bx-soa-coupon bx-soa-section bx-active">
				...
				<!--	ORDER SAVE BLOCK	-->
				<div id="bx-soa-orderSave" <?if(isset($_COOKIE["ORDER_OPENED"]) && $_COOKIE["ORDER_OPENED"] == "Y"):?>class="opened"<?endif;?>>
					<div class="checkbox">
						<?
